          ...
          <form @submit.prevent="submitForgotPassword" class="space-y-6">
            ...
            <div>
              ...
              <div class="mt-1 relative">
                <input id="email" v-model="forgotForm.email" @input="clearError('email')" type="email"
                  autocomplete="email" required
                  class="appearance-none block w-full px-3 py-2 border rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm transition border-gray-300"
